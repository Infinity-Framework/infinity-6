...
--= Type Export =--
type States         = {
    Get: (managerName: string, stateKey: string) -> (),
    Set: (managerName: string, stateKey: string, stateValue: any) -> (),
    GetChangedSignal: (managerName: string) -> RBXScriptSignal,
    GetKeyChangedSignal: (managerName: string, stateKey: string) -> RBXScriptSignal
}
...
function States:GetChangedSignal(manager: string): RBXScriptSignal
    return validate(manager)._event.Event
end

function States:GetKeyChangedSignal(manager: string, key: string): RBXScriptSignal

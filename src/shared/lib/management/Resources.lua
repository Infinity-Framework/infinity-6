...
--= Type Export =--
type Resources  = {
    Fetch: (resourcePath: string) -> Instance|nil,
    Get: (resourcePath: string) -> Instance|nil
}
...
--= API =--
function Resources:Fetch(query: string): Instance|nil
    local result = nil
    local _nodes = { }
    local _first
...
function Resources:Get(query: string): Instance|nil
    local result = nil
    local _nodes = { }
    local _first
